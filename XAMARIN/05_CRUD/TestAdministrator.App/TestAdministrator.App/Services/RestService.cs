...
namespace TestAdministrator.App.Services
{
    ...
    public class RestService
    {
        ...
        public Task<string> SendAsync(HttpMethod method, string actionUrl) => SendAsync(method, actionUrl, "", null);
        public Task<string> SendAsync(HttpMethod method, string actionUrl, object requestData) => SendAsync(method, actionUrl, "", requestData);
        public Task<string> SendAsync(HttpMethod method, string actionUrl, string idParam) => SendAsync(method, actionUrl, idParam, null);
        /// <summary>
        /// Sendet einen Request an die REST API und gibt das Ergebnis als String zurück.
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<string> SendAsync(HttpMethod method, string actionUrl, string idParam, object requestData)
        {
        ...
        {
            string result = await SendAsync(method, actionUrl, idParam, requestData);
            try
            {
